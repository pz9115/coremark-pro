...
LDPP	= $(TOOLS)/bin/riscv64-unknown-linux-gnu-g++
EXEOUT	= -o
EXE		= .exe
...
INCLUDE = $(TOOLS)/sysroot/usr/include
...
COMPILER_FLAGS = -Os $(CDEFN)NDEBUG $(CDEFN)HOST_EXAMPLE_CODE=1 -std=gnu99 
...
LINKER_INCLUDES	= $(TOOLS)/sysroot/usr/lib
